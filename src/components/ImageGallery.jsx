...
const ImageGallery = () => {
  ...
  useEffect(() => {
    ...
    window.ontouchmove = (e) => handleOnMove(e.touches[0]);}, [window]);
  return (
    <div>
      <div id="image-track" ref={track} data-mouse-down-at="0" data-prev-percentage="0">
        ...
        <img className="image" src="https://media.discordapp.net/attachments/981697658894839848/1081131775272689684/Timmy_sleek_blue_luxury_sports_car_in_motion_8k_hdr_raytracing__b7cd264a-7cc9-4077-9c9c-42bd8ad1ed9f.png?width=701&height=701" draggable="false" />
        ...
        <img className="image" src="https://media.discordapp.net/attachments/942504198887583814/1081114747266662410/Timmy_sleek_blue_luxury_sports_car_in_motion_8k_hdr_raytracing__2bbb607d-5581-441d-b0ae-b8d7be0419dc.png?width=701&height=701" draggable="false" />
        ...
        <img className="image" src="https://media.discordapp.net/attachments/981697658894839848/1081132031481753650/Timmy_sleek_blue_luxury_sports_car_in_motion_8k_hdr_raytracing__8b404074-8bd5-4ccc-a88d-67c3f771f500.png?width=701&height=701" draggable="false" />
